...
ws = openpyxl.load_workbook(r"F:\sequelstring\Excel\NEELMETAL_OUTPUT\Output\sub_assy_hierachy.xlsx", data_only=True)
ws = wb['Sheet']
    ...
    if category == "Sub assy & BOP":
        ...
        for j in range(9, 73):
            ...
            if front_partcode == summary_part and revised_price == summary_price or revised_price == summary_price1:
                ...
                # print(summary_part)
                # print("summary_bop_working_rev_f", summary_bop_working_rev_f, "K" + str(j))
                        ...
                        if ":" in aawd_price_f:
                            ...
                            for c in range(int(x), int(y) + 1):
                                ...
                                if aawd_gross_wt == None and aawd_net_wt == None and aawd_process_cost == None and aawd_dep_cost == None and aawd_tooling_cost == None and aawd_overhead == None and aawd_profit_NRMC == None and aawd_profit_process == None and aawd_rej_NRMC == None and aawd_rej_process == None and aawd_fr_NRMC == None and aawd_fr_process == None:
                                    ...
                                    l1 = ["", direct_vendor, "", plan, from_date, to_date, front_partcode, "OE", aawd_child, "INM"]
                                    ws.append(l1)
                                    l1 = ["", direct_vendor, "", plan, from_date, to_date, front_partcode, "OE", aawd_child, "INM", aawd_sub_child, "INM"]
                                    ws.append(l1)
                                    l1 = ["", direct_vendor, "", plan, from_date, to_date, front_partcode, "OE", aawd_child, "INM", aawd_sub_child, "INM", aawd_rm_grade, "RM"]
                                    ws.append(l1)
                                    l1 = ["", direct_vendor, "", plan, from_date, to_date, front_partcode, "OE", aawd_child, "INM", aawd_sub_child, "INM", "Scrap", "RM"]
                                    ws.append(l1)

                                    if aawd_gross_wt == None and aawd_net_wt == None:
                                        l1 = ["", direct_vendor, "", plan, from_date, to_date, front_partcode, "OE", aawd_child, "INM"]
                                        ws.append(l1)
                                        l1 = ["" , direct_vendor, "", plan, from_date, to_date, front_partcode, "OE", aawd_child, "INM", aawd_sub_child, "BOP"]
                                    ws.append(l1)
                                    print(l1)
...
wb.save(r"F:\sequelstring\Excel\NEELMETAL_OUTPUT\Output\sub_assy_hierachy.xlsx")
