...
ws = openpyxl.load_workbook(r"F:\sequelstring\Excel\NEELMETAL_OUTPUT\Output\vtv_master.xlsx", data_only=True)
ws = wb['Sheet']
...
for i in range(5, 38):
    ...
    for j in range(9, 73):
        ...
        if vtv_part == summary_part and revised_price == summary_price:
            ...
            l1 = [vtv_part, "interest_cost", direct_vendor, plan, "", from_date, to_date, "", summary_interest_cost]
            ws.append(l1)
            l1 = [vtv_part, "depriciation_cost", direct_vendor, plan, "", from_date, to_date, "", summary_depriciation_cost]
            ws.append(l1)
            l1 = [vtv_part, "Wire_and_Co2_gas", direct_vendor, plan, "", from_date, to_date, "", summary_Wire_and_Co2_gas]
            ws.append(l1)
            l1 = [vtv_part, "other_cost", direct_vendor, plan, "", from_date, to_date, "", summary_other_cost]
            ws.append(l1)
            l1 = [vtv_part, "welding_fix_cost", direct_vendor, plan, "", from_date, to_date, "", summary_welding_fix_cost]
            ws.append(l1)
            l1 = [vtv_part, "press_shop_cost", direct_vendor, plan, "", from_date, to_date, "", summary_press_shop_cost]
            ws.append(l1)
            l1 = [vtv_part, "OH_at_30_cost", direct_vendor, plan, "", from_date, to_date, "", summary_OH_at_30_cost]
            ws.append(l1)
            l1 = [vtv_part, "profit_cost", direct_vendor, plan, "", from_date, to_date, "", summary_profit_cost]
            ws.append(l1)
            l1 = [vtv_part, "rejection_at_rm_and_conv_cost", direct_vendor, plan, "", from_date, to_date, "", summary_rejection_at_rm_and_conv_cost]
            ws.append(l1)
            l1 = [vtv_part, "paking_exp_cost", direct_vendor, plan, "", from_date, to_date, "", summary_paking_exp_cost]
            ws.append(l1)
            l1 = [vtv_part, "freight_cost", direct_vendor, plan, "", from_date, to_date, "", summary_freight_cost]
            ws.append(l1)
            l1 = [vtv_part, "ammortization_cost", direct_vendor, plan, "", from_date, to_date, "", summary_ammortization_cost]
            ws.append(l1)
            l1 = [vtv_part, "power_welding", direct_vendor, plan, "", from_date, to_date, "", summary_power_welding]
            ws.append(l1)
            l1 = [vtv_part, "power_press_shop", direct_vendor, plan, "", from_date, to_date, "", summary_power_press_shop]
            ws.append(l1)
            l1 = [vtv_part, "labour_welding", direct_vendor, plan, "", from_date, to_date, "", summary_labour_welding]
            ws.append(l1)
            l1 = [vtv_part, "labour_press_shop", direct_vendor, plan, "", from_date, to_date, "", summary_labour_press_shop]
            ws.append(l1)
            l1 = [vtv_part, "labour_other_assy_operation", direct_vendor, plan, "", from_date, to_date, "", summary_labour_other_assy_operation]
            ws.append(l1)
            l1 = [vtv_part, "rm_sec_operaton_charges", direct_vendor, plan, "", from_date, to_date, "", summary_rm_sec_operaton_charges]
            ws.append(l1)
            l1 = [vtv_part, "additional_price", direct_vendor, plan, "", from_date, to_date, "", summary_additional_price]
            ws.append(l1)
                    ...
                    for x in neel_price_f1:
                        ...
                        if ":" in str(neel_price_fx):
                            ...
                            for c in range(int(x), int(y) + 1):
                                ...
                                if neel_gross_wt == None and neel_net_wt == None  and neel_tooling_cost == None and neel_overhead == None and neel_profit_NRMC == None and neel_profit_process == None and neel_rej_NRMC == None and neel_rej_process == None and neel_fr_NRMC == None and neel_fr_process == None:
                                    continue
                                else:
                                    l1 = [str(vtv_part) + "_" + str(neel_child) + "_" + str(neel_sub_child) + "_" + neel_RM_grade, "gross_wt", direct_vendor, plan,"", from_date, to_date, "", neel_gross_wt]
                                    ws.append(l1)
                                    # print(l1)
                                    l1 = [str(vtv_part) + "_" + str(neel_child) + "_" + str(neel_sub_child) + "_" + neel_RM_grade, "net_wt", direct_vendor, plan,"", from_date, to_date, "", neel_net_wt]
                                    ws.append(l1)
                                    l1 = [str(vtv_part) + "_" + str(neel_child) + "_" + str(neel_sub_child), "process_cost", direct_vendor, plan,"", from_date, to_date, "", neel_process_cost]
                                    ws.append(l1)
                                    l1 = [str(vtv_part) + "_" + str(neel_child) + "_" + str(neel_sub_child), "dep_cost", direct_vendor, plan,"", from_date, to_date, "", neel_dep_cost]
                                    ws.append(l1)
                                    l1 = [str(vtv_part) + "_" + str(neel_child) + "_" + str(neel_sub_child), "tooling_cost", direct_vendor, plan,"", from_date, to_date, "", neel_tooling_cost]
                                    ws.append(l1)
                                    l1 = [str(vtv_part) + "_" + str(neel_child) + "_" + str(neel_sub_child), "overhead", direct_vendor, plan,"", from_date, to_date, "", neel_overhead]
                                    ws.append(l1)
                                    l1 = [str(vtv_part) + "_" + str(neel_child) + "_" + str(neel_sub_child), "profit_NRMC", direct_vendor, plan,"", from_date, to_date, "", neel_profit_NRMC]
                                    ws.append(l1)
                                    l1 = [str(vtv_part) + "_" + str(neel_child) + "_" + str(neel_sub_child), "profit_process", direct_vendor, plan,"", from_date, to_date, "", neel_profit_process]
                                    ws.append(l1)
                                    l1 = [str(vtv_part) + "_" + str(neel_child) + "_" + str(neel_sub_child), "rej_NRMC", direct_vendor, plan,"", from_date, to_date, "", neel_rej_NRMC]
                                    ws.append(l1)
                                    l1 = [str(vtv_part) + "_" + str(neel_child) + "_" + str(neel_sub_child), "rej_process", direct_vendor, plan,"", from_date, to_date, "", neel_rej_process]
                                    ws.append(l1)
                                    l1 = [str(vtv_part) + "_" + str(neel_child) + "_" + str(neel_sub_child), "fr_NRMC", direct_vendor, plan,"", from_date, to_date, "", neel_fr_NRMC]
                                    ws.append(l1)
                                    l1 = [str(vtv_part) + "_" + str(neel_child) + "_" + str(neel_sub_child), "fr_process", direct_vendor, plan,"", from_date, to_date, "", neel_fr_process]
                                    ws.append(l1)
                                        
                                    if neel_gross_wt == None and neel_net_wt == None:
                                        l1 = [str(vtv_part) + "_" + str(neel_child) + "_" + str(neel_sub_child), "NO_OFF", direct_vendor, plan,"", from_date, to_date, "", neel_no_off]
                                        ws.append(l1)
                                        l1 = [str(vtv_part) + "_" + str(neel_child) + "_" + str(neel_sub_child), "BOP_COST", direct_vendor, plan,"", from_date, to_date, "", neel_bop_cost]
                                        ws.append(l1)
                            ...
                            if neel_gross_wt == None and neel_net_wt == None and neel_process_cost == None and neel_dep_cost == None and neel_tooling_cost == None and neel_overhead == None and neel_profit_NRMC == None and neel_profit_process == None and neel_rej_NRMC == None and neel_rej_process == None and neel_fr_NRMC == None and neel_fr_process == None:
                                ...
                                l1 = [vtv_part + "_" + bop, "gross_wt", direct_vendor, plan,"", from_date, to_date, "", neel_gross_wt]
                                ws.append(l1)
                                print(l1, "222222222222222222")
                                l1 = [vtv_part + "_" + bop , "net_wt", direct_vendor, plan,"", from_date, to_date, "", neel_net_wt]
                                ws.append(l1)
                                l1 = [vtv_part + "_" + bop, "process_cost", direct_vendor, plan,"", from_date, to_date, "", neel_process_cost]
                                ws.append(l1)
                                l1 = [vtv_part + "_" + bop, "dep_cost", direct_vendor, plan,"", from_date, to_date, "", neel_dep_cost]
                                ws.append(l1)
                                l1 = [vtv_part + "_" + bop, "tooling_cost", direct_vendor, plan,"", from_date, to_date, "", neel_tooling_cost]
                                ws.append(l1)
                                l1 = [vtv_part + "_" + bop, "overhead", direct_vendor, plan,"", from_date, to_date, "", neel_overhead]
                                ws.append(l1)
                                l1 = [vtv_part + "_" + bop, "profit_NRMC", direct_vendor, plan,"", from_date, to_date, "", neel_profit_NRMC]
                                ws.append(l1)
                                l1 = [vtv_part + "_" + bop, "profit_process", direct_vendor, plan,"", from_date, to_date, "", neel_profit_process]
                                ws.append(l1)
                                l1 = [vtv_part + "_" + bop, "rej_NRMC", direct_vendor, plan,"", from_date, to_date, "", neel_rej_NRMC]
                                ws.append(l1)
                                l1 = [vtv_part + "_" + bop, "rej_process", direct_vendor, plan,"", from_date, to_date, "", neel_rej_process]
                                ws.append(l1)
                                l1 = [vtv_part + "_" + bop, "fr_NRMC", direct_vendor, plan,"", from_date, to_date, "", neel_fr_NRMC]
                                ws.append(l1)
                                l1 = [vtv_part + "_" + bop, "fr_process", direct_vendor, plan,"", from_date, to_date, "", neel_fr_process]
                                ws.append(l1)
...
# wb.save(r"F:\sequelstring\Excel\NEELMETAL_OUTPUT\Output\vtv_master.xlsx")
